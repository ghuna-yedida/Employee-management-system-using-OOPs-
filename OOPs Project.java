...
class Emp
{
//Creating ArrayList to store the Employee Data
...
// Method for Adding Employee Details 
...
//Method for viewing details of single Employee 
    	public void viewsingle()
	{
    		...
    		if(eid.size()>0 && x>=0)
		{
   			...
   			System.out.println(n+" "+"mobile number is "+emobilenum.get(x));
    			...
    			System.out.println(n+" "+"has experience of "+eexp.get(x)+" months");
		}
		else
		{
...
//Method for viewing the details of all Employees
	public void allview()
	{
    		int c=0;
    		while(c<eid.size())
		{
    			...
    			System.out.println(n+" "+"has experience of "+eexp.get(c)+" months");
    			System.out.println("------------------------------------------------------------------------------------");
    			System.out.println("------------------------------------------------------------------------------------");
    			c=c+1;
    		}
...
//Method for deleting the details of a Employee
	public void delete()
	{
